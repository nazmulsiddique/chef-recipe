...
<body>
    <div class="top-bar-area">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link px-4" href="#">Products</a></li>
                            <li class="nav-item"><a class="nav-link px-4" href="#">About Us</a></li>
                            <li class="nav-item"><a class="nav-link px-4" href="#">How To & Tips</a></li>
        ...
        <section class="pb-5 pb-lg-0 mt-5">
            <div class="container">
                <div class="row align-items-start position-relative" style="min-height: 500px;">
                    <div class="col-lg-7">
                        <h1 class="hero-title">Chef’s Perfect Recipe</h1>
                        <p class="lead mb-4 pe-md-5">
                    ...
                    <div>
                        <div class="text-center text-lg-end position-absolute left-0 top-0 d-none d-md-block" style="width: 700px; right:0;">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mt-4">
                    <div class="category-item">
                        ...
                        <div class="category-info">
                            <h5 class="mt-3">Tandoori Chicken</h5>
                ...
                <div class="col-lg-3 mt-4">
                    <div class="category-item">
                        ...
                        <div class="category-info">
                            <h5 class="mt-3">Maltova Biscuit</h5>
                ...
                <div class="col-lg-3 mt-4">
                    <div class="category-item">
                        ...
                        <div class="category-info">
                            <h5 class="mt-3">Butter salt Biscuit</h5>
